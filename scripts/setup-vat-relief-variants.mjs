...
const ACCESSORY_HANDLES = [
  ...
  'umbrella-holder-m4-pro-x12',
  'universal-wheels-for-xsto-m4',
  'wheelchair-battery-charger',
  'x12-x12-pro-battery-25-2v-25-6ah',
  'cane-holder-m4',
  'cooling-seat-cushion-m4-pro-x12',
  'ct420-handle-joystick-knob',
  'm4-m4-pro-battery-25-2v-23-8ah',
  'm4-pro-handle-fixing-plate',
  'm4-spare-left-front-mud-cover',
  'm4-spare-right-front-mud-cover',
  'm4-spare-seat-connector-female-socket',
  'phone-holder-m4-pro-x12',
  'rear-push-handles-m4',
  'rear-view-mirror-m4-pro-x12',
  'straight-backrest-cushion-l-m4-pro-x12',
  'straight-backrest-cushion-m-m4-pro-x12',
  'straight-backrest-cushion-s-m4-pro-x12',
  'straight-quick-release-backboard-m4-pro',
