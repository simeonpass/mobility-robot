...
export const ABOUT_INTRO = [
  ...
  'From our base in Wimborne, Dorset, we supply the full XSTO range including the M4, M4 Pro, M4B, X12 and X12 Pro, with free UK delivery, VAT relief eligibility and comprehensive warranty support.',
