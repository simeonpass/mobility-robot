...
export const FAQ_CATEGORIES: FaqCategory[] = [
  {
    id: 'product',
    title: 'Product',
    items: [...m4FAQs, ...m4bFAQs, ...m4ProFAQs, ...x12FAQs],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Bentech Medical Ltd appoints authorised UK and Ireland stockists. Email sales@bentechmeduk.com with your company details and territory to discuss partnership.',
      },
    ],
  },
];
