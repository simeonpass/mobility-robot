...
const SOCIAL_ICONS: Record<(typeof SOCIAL_LINKS)[number]['label'], React.ReactNode> = {
  Facebook: (
    ...
    <div className="bg-navy text-white">
      <div className="xsto-container py-10 md:py-14">
        <div className="grid gap-10 md:grid-cols-12 md:gap-8 lg:gap-12">
          <div className="md:col-span-5 lg:col-span-4">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2">
              {SOCIAL_LINKS.map((link) => (
                <SocialLink href={link.href} key={link.href} label={link.label}>
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 md:col-span-7 lg:col-span-8 lg:gap-10">
