    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-[100svh] w-full max-w-[1400px] flex-col justify-end px-6 pb-16 pt-32 sm:px-8 md:pb-24 md:pt-36 lg:pb-28">
        <div className="max-w-2xl text-left text-white">
          <motion.p
            className="font-serif mb-2 text-[1.875rem] italic leading-none text-white md:mb-3 md:text-[2.5rem] lg:text-[3rem]"
          ...
          <motion.p
            className="mb-6 max-w-lg text-base leading-relaxed text-white/90 md:mb-8 md:text-lg"
          ...
          >
            ...
            <Link
              className="btn-hero-secondary inline-flex h-12 items-center justify-center gap-2 rounded-lg border border-white/80 bg-black/25 px-6 text-sm font-medium text-white no-underline backdrop-blur-sm transition-colors hover:border-white hover:bg-black/40 hover:text-white hover:no-underline md:h-14"
              to="/vat-relief"
            >
              <BadgePercent
                aria-hidden
